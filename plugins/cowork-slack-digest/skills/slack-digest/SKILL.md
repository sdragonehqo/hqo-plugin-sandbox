...
Read `~/Documents/ppt-index/config.md` (using the resolved path from Step 0) for the list of monitored Slack channels. If the file doesn't exist, only process DMs and note that no channels are configured.
